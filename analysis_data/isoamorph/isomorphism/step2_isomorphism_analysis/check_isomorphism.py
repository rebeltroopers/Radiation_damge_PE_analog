...
##### Get Graph 1 #####
graph1 		    = nx.Graph()
for i in range(natom1): #use to be xrange
	newline1    = finstream1.readline()
...
for i in range(natom1): #use to be xrange
	...
	for j in range(nbonds): #use to be xrange
...
##### Get Graph 2 #####
graph2 		    = nx.Graph()
for i in range(natom2):  #use to be xrnge
	newline2    = finstream2.readline()
...
for i in range(natom2):  #use to be xrange
	newline2    = finstream2.readline()
