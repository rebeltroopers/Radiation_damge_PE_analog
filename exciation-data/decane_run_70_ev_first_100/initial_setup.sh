...
Texcite='541544.178' #'232090.362'		#Excitation energy for excited atom in Kelvin (KE = 3*kB*T/2)
...
#        echo $length
	...
	echo the picked atom $picked_atom >> workdir/sim.$j/picked_atom.txt
	echo the atom that got excited $excitedatom >> workdir/sim.$j/picked_atom.txt
	echo sim that was picked was $start_frame >> workdir/sim.$j/picked_atom.txt
        ...
        echo '#MSUB -l walltime=00:190:00:00'               >> submit_borax.csh
